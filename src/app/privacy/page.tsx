      ...
      <section className="mb-10">
          ...
          <p className="text-muted-foreground mb-4">
              ...
              <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-2">
                  ...
                  <li>Use our Service features</li>
              </ul>
              <p className="text-muted-foreground mb-4">
              ...
              <h3 className="text-lg font-medium mb-3 mt-6">Content Data</h3>
              <p className="text-muted-foreground mb-4">
                  When you upload content to our Service, we store and process that content to provide you with AI-generated
                  insights, summaries, and other features. Your uploaded content is used solely to deliver our Service to you.
              </p>
              ...
              <ul className="list-disc list-inside text-muted-foreground mb-4 space-y-2">
                  <li><strong>Service Providers:</strong> We may share your information with third-party service providers
                      who perform services for us, such as payment processing (Stripe), cloud hosting, and analytics.</li>
                  ...
                  <li><strong>Business Transfers:</strong> We may share or transfer your information in connection with a
                      merger, acquisition, or sale of all or a portion of our assets.</li>
              </ul>
          </section><section className="mb-10">
              ...
              <p className="text-muted-foreground mb-4">
                  If you delete your account, we will delete your personal information and uploaded content within 30 days,
                  except for information we are required to retain for legal or legitimate business purposes.
              </p>
          </section><section className="mb-10">
              ...
              <p className="text-muted-foreground mb-4">
                  ...
                  <a href="mailto:privacy@ragment.com" className="text-foreground underline hover:text-muted-foreground">
                      privacy@ragment.com
                  </a>
              </p>
          </section>
